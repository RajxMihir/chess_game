...
document.addEventListener('DOMContentLoaded', () => {
    let board = null; // Initalize the chessboard
    ...
    let moveCount = 1; // Initalize  the move count
    ...
    // Event lsitener for the "Play Again" button
    ...
    document.querySelector('.flip-board').addEventListener('click', () => {
        board.flip();
        makeRandomMove();
        // Toggle user's color flipping the board 
